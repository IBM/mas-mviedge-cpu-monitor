...
**22 April 2024 Update**: This tutorial was run with a later Ubuntu version (22.04.4), and the latest MVI Edge (8.9.0) and MVI (8.9.1) on a MAS 8.11.9 version. Except for some minor UI changes, the steps of this tutorial still work.<br>
